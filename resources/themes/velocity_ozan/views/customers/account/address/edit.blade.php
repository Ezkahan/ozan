...
@section('page_title')
    {{ __('velocity::app.customer.account.address.edit.page-title') }}
@endsection

@section('page-detail-wrapper')
    <div class="account-head mb-15">
        <span class="back-icon"><a href="{{ route('customer.account.index') }}"><i class="icon icon-menu-back"></i></a></span>
        <span class="account-heading">{{ __('velocity::app.customer.account.address.edit.title') }}</span>
        <span></span>
    </div>
    ...
    <form method="post" action="{{ route('customer.address.update', $address->id) }}" @submit.prevent="onSubmit">
        ...
        <div class="account-table-content">
            ...
            <div class="control-group" :class="[errors.has('last_name') ? 'has-error' : '']">
                ...
                <input type="text" class="control" name="last_name" value="{{ old('last_name') ?? $address->last_name }}" v-validate="'required'" data-vv-as="&quot;{{ __('velocity::app.customer.account.address.create.last_name') }}&quot;">
            ...
            <div class="control-group" :class="[errors.has('address1[]') ? 'has-error' : '']">
                ...
                <input type="text" class="control" name="address1[]" value="{{ isset($addresses[0]) ? $addresses[0] : '' }}" id="address_0" v-validate="'required'" data-vv-as="&quot;{{ __('velocity::app.customer.account.address.create.street-address') }}&quot;">
            ...
            <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                ...
                <input type="text" class="control" name="phone" value="{{ old('phone') ?? $address->phone }}" v-validate="'required'" data-vv-as="&quot;{{ __('velocity::app.customer.account.address.create.phone') }}&quot;">
