        ...
        <div class="add-to-cart-btn pl0">
            @if (isset($form) && !$form)
                <button
                    ...
                    {{ ($product->type == 'booking') ?  __('shop::app.products.book-now') :  __('velocity::app.home.add-to-cart') }}
                </button>
                ...
                <form
                    ...
                    <button
                        ...
                        <span class="fs14 fw6 text-uppercase text-up-4">
                            {{ ($product->type == 'booking') ?  __('shop::app.products.book-now') : $btnText ?? __('velocity::app.home.add-to-cart') }}
                        </span>
                    </button>
                </form>
            @else
                <add-to-cart
                    ...
                    btn-text="{{ (! isset($moveToCart) && $product->type == 'booking') ?  __('shop::app.products.book-now') : $btnText ?? __('velocity::app.home.add-to-cart') }}">
                </add-to-cart>
            @endif
        </div>
    </div>
