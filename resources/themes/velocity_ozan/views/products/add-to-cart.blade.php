        ...
        <div class="add-to-cart-btn pl0">
            ...
            @elseif(isset($addToCartForm) && !$addToCartForm)
                <form
                    ...
                    <button
                        type="submit"
                        {{ !$product->isSaleable() ? 'test 2 disabled' : '' }}
                        ...
                        <span class="fs14 fw6 text-uppercase text-up-4">
                            {{ $product->type == 'booking' ? __('velocity::app.products.book-now') : $btnText ?? __('velocity::app.home.add-to-cart') }}
                        </span>
                    </button>
                </form>
            @else
                <add-to-cart
                    ...
                    btn-text="{{ !isset($moveToCart) && $product->type == 'booking' ? __('velocity::app.products.book-now') : $btnText ?? __('velocity::app.home.add-to-cart') }}">
                </add-to-cart>
            @endif
            </div>
</div>
