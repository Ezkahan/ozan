        ...
        <div class="auto__container">
            <div class="register__inner">
                    ...
                    <div class="register__form">
                        ...
                        <div class="register__row">
                            ...
                            <div class="register__column">
                                ...
                                <div class="input__outer" :class="[errors.has('first_name') ? 'has-error' : '']">
                            ...
                            <div class="register__column">
                                ...
                                <div class="input__outer" :class="[errors.has('last_name') ? 'has-error' : '']">
                            ...
                            <div class="register__column">
                                ...
                                <div class="input__outer" :class="[errors.has('password_confirmation') ? 'has-error' : '']">
                ...
                Checkbox Value 1
                        ...
                        <button class="register__btn btn-primary btn-lg" type="submit">
