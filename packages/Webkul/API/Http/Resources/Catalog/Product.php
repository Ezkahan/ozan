...
class Product extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'minimal_price'          => (isset($request->inventory_source_id)) ? $this->getInventoryPrice($product, $request->inventory_source_id) : $product->price,
            ...
            'formated_minimal_price' => core()->currency((isset($request->inventory_source_id)) ? $this->getInventoryPrice($product, $request->inventory_source_id) : $product->price),
