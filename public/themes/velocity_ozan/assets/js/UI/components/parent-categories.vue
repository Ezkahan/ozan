    ...
    <div class="hero__sidebar-inner faq">
        <a v-for="(category, index) in $root.sharedRootCategories" :key="index" :href="category.slug" class="card" style="border-radius: 0;">
            <div class="hero__sidebar-inner-link">
                <div class="category_icon" style=" background-color: red;
                                                    -webkit-mask: url(http://127.0.0.1:8000/themes/velocity_ozan/assets/images/svg/instagram.svg) no-repeat center;
                                                    mask: url(http://127.0.0.1:8000/themes/velocity_ozan/assets/images/svg/instagram.svg) no-repeat center;
                                                    width: 20px; height:20px
                                                    mask-image: url(http://127.0.0.1:8000/themes/velocity_ozan/assets/images/svg/instagram.svg);">
